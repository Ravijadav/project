...
consumer.find({userName:user},function(err,interests){
 if(err){console.log(err)}
    ...
    interest3=interests[0].interestCategory3;
    	...
    	//console.log('interest is:'+interest1)
        ...
        provider.find({category:interest1},{_id:0,__v:0},function(err,providers1){
        	if(err){console.log('error')}
   			...
   			$("#event1").attr("href","http://52.74.122.82:3000/providers/"+providers1[0].eventName);
   			$("#event2").attr("href","http://52.74.122.82:3000/providers/"+providers1[1].eventName);
   			$("#event3").attr("href","http://52.74.122.82:3000/providers/"+providers1[2].eventName);
   			...
   			provider.find({category:interest2},{_id:0,__v:0},function(err,providers2){
        			if(err){console.log('err')}
   					...
   					$("#interest2Event1").attr("href","http://52.74.122.82:3000/providers/"+providers2[0].eventName);
   					$("#interest2Event2").attr("href","http://52.74.122.82:3000/providers/"+providers2[1].eventName);
   					$("#interest2Event3").attr("href","http://52.74.122.82:3000/providers/"+providers2[2].eventName);
   	...
   	if(providers2[0].category=='music'){
   				...
   				$("#image2").attr("src","http://www.naz.edu/health-and-human-services/social-work/SW%20Documents/Social%20Event%20Icon.jpg/image_preview");
   					...
   					$("#interest3Event1").attr("href","http://52.74.122.82:3000/providers/"+providers3[0].eventName);
   					$("#interest3Event2").attr("href","http://52.74.122.82:3000/providers/"+providers3[1].eventName);
   					$("#interest3Event3").attr("href","http://52.74.122.82:3000/providers/"+providers3[2].eventName);
